...
No Windows, se o arquivo `C:\Users\ana.silva\OneDrive - PRODESP\SP_AGUAS\Sistema de Gestão de Demandas - SP Aguas.xlsx` existir, o aplicativo tambem o detecta automaticamente mesmo quando iniciado diretamente com `python app.py`.
